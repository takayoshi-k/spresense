...
extern int nrc_hspi_open (void);
extern void nrc_hspi_close (void);

extern int nrc_hspi_read (char *data, int len);
extern int nrc_hspi_write (char *data, int len);

// Mutex protected read and write calls
extern int nrc_hif_read (char *data, int len);
extern int nrc_hif_write (char *data, int len);
